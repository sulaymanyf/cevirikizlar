...
public class Sequence {
    ...
    public Sequence(long workerId, long datacenterId) {
        Assert.isTrue(workerId <= 31L && workerId >= 0L, String.format("worker Id can't be greater than %d or less than 0", 31L));
        Assert.isTrue(datacenterId <= 31L && datacenterId >= 0L, String.format("datacenter Id can't be greater than %d or less than 0", 31L));
